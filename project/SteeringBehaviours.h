...
class SteeringBehaviour final
{
	...
	Elite::Vector2 m_WanderTarget = { cosf(m_Theta) * m_WanderRadius, sinf(m_Theta) };
...
public: 
	...
	Elite::Vector2 Wander(const AgentInfo& agentInfo, float wanderRadius, float jitterMultiplier = 1.f);
};